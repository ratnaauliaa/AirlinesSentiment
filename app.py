...
model_file = 'Tuning-Model-NB.pkl'
...
# Image and caption
image_path = os.path.join('C:/Streamlit/pesawat/gambar', 'gambar.jpeg')
image = Image.open(image_path)
st.image(image)

# Loading the data
data_path = os.path.join('C:/Streamlit/pesawat/dataset', 'datafinal.csv')
...
if st.sidebar.checkbox("Display Word Cloud"):
    ...
    image_path = os.path.join('C:/Streamlit/pesawat/gambar', f'{select.lower()}.png')
    image = Image.open(image_path)
    st.image(image)
